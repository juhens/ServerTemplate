...
{
    public class TransactionComponent<TSession> where TSession : Session
    {
        public TransactionComponent(TSession session, Action<TSession> logout)
        {
            _session = session;
            _logout = logout;
        }
        ...
        private readonly Action<TSession> _logout;
        ...
        public TContext CreateContext<TContext>() where TContext : BaseContext<TSession, TContext>, new()
        {
            var ctx = BaseContext<TSession, TContext>.Create();
